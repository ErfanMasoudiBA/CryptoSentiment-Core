              ...
              <div className="space-y-3">
                <label className="block">
                  <select
                    ...
                    onChange={(e) =>
                      setAIModel(
                        e.target.value as "VADER (Fast)" | "FinBERT (Accurate)"
                      )
                    }
                    className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all-fast touch-target"
                  >
                    <option value="VADER (Fast)">VADER (Fast)</option>
                    <option value="FinBERT (Accurate)">
                      FinBERT (Accurate)
                    </option>
                  </select>
                </label>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-slate-300">
                        <strong className="text-white">VADER (Fast):</strong>{" "}
                        Quick sentiment analysis using rule-based approach. Best
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-slate-300">
                        ...
                        Deep learning model trained on financial texts. More
                        accurate but slower.
                      </span>
                    </div>
                  </div>
                  <p className="mt-4 text-xs text-slate-500 italic">
                    Note: This is a UI placeholder. Model selection will be
